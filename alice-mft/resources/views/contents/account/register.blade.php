...
@section("section")
    <div id="foreground" style="display: flex;">
        <div id="form" class="box">
            ...
            <form>
                <div class="field">
                    <label class="label" for="email">Registration key</label>
                    <input id="email" type="text" name="email" pattern="^([a-f0-9]{8}(-[a-f0-9]{4}){4}[a-f0-9]{8})$" required>
                    <label class="helper" for="email">If you do not have your registration key yet, you can <a href="#">continue as a guest</a>.</label>
                </div>
                <div class="field">
